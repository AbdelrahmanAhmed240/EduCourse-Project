  ...
  return (
    <DotPattern>
      ...
      <div className="py-5 container">
        <div className="card p-4 border-secondary mx-auto bg-dark shadow-lg" style={{ maxWidth: '600px' }}>
          ...
          <form onSubmit={handleCreate}>
            ...
            <button type="submit" className="custom-btn fw-bold w-100 py-3 rounded-3" disabled={loading}>
              {loading ? "Forging Knowledge..." : "Create Course ✨"}
            </button>
          </form>
        </div>
      </div>

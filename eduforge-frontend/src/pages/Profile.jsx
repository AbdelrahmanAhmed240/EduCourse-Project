...
import { FaUser, FaEnvelope, FaGem, FaCalendarAlt } from 'react-icons/fa'; // Added standard icons
...
const Profile = () => {
  ...
  return (
    ...
    <div className="container my-5">
      <div className="card bg-dark border-secondary shadow-lg p-4 rounded-2">
        ...
        <div className="d-flex flex-column gap-2">
          ...
          <p className="text-white"><strong><FaGem className="text-warning m-2" />Plan:</strong> <span className="badge bg-warning text-dark p-2">{user.plan}</span></p>
